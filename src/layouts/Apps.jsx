...
const Apps = memo(() => {
  ...
  const SORT_OPTIONS = useMemo(() => [
    { value: 'categorical', label: t('apps.sort.categorical') },
    { value: 'alphabetical', label: t('apps.sort.alphabetical') },
    { value: 'newest', label: t('apps.sort.newest') },
  ], [t]);
  ...
  const placeholder = useMemo(() => t('apps.search').replace('{n}', appsList.length), [t, appsList.length]);
