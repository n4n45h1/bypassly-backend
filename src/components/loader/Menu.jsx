...
export default function Menu() {
  ...
  const items = [
    ...
    {
      name: t('menu.clearTabs'),
      shortcut: 'alt + c',
      fn: clearTabs,
    },
    { name: t('menu.bookmarks'), shortcut: 'alt + b', fn: () => setShowBm(true) },
    {
      name: t('menu.fullscreen'),
      shortcut: 'shift + f',
      fn: fs,
      disabled: !activeFrameRef?.current,
    },
    { name: 'zoom-cmpn', isComponent: true, divider: true },
    { name: t('menu.hideUI'), shortcut: 'alt + z', fn: toggleUI },
    {
      name: t('menu.devtools'),
      shortcut: 'alt + i',
      fn: togEruda,
      disabled: !activeFrameRef?.current,
      divider: true,
    ...
    {
      name: t('menu.findInPage'),
      shortcut: 'ctrl + f',
      fn: toggleFind,
      disabled: !activeFrameRef?.current,
    },
    {
      name: t('menu.translate'),
      shortcut: 'alt + t',
      fn: toggleTranslate,
      disabled: !activeFrameRef?.current,
    },
    {
      name: t('menu.cssInject'),
      shortcut: 'alt + e',
      fn: toggleCss,
      divider: true,
    },
    { name: t('menu.returnHome'), fn: () => nav('/') },
  ];
  ...
  useEffect(() => {
    const shortcuts = {
      ...
      'alt+t': () => activeFrameRef?.current && toggleTranslate(),
      'alt+e': toggleCss,
    };
  ...
  }, [newTab, clearTabs, fs, activeFrameRef, toggleUI, togEruda, toggleTranslate, toggleCss]);
